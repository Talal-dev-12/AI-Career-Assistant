...
from mabd.models.models import User, Job, UserSkill, SkillGapAnalysis
from mabd.services.llm import generate_skill_gap_analysis
from fastapi import HTTPException

def analyze_skill_gap(session: Session, user_id: str, job_id: str) -> SkillGapAnalysis:
